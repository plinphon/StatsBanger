import { ALL_SEASON_STAT_CATEGORIES, SEASON_STAT_CATEGORY_LABELS, isSeasonPercentageStat, formatSeasonMetricName } from "../../utils/rawPlayerseasonStats";
...
export function SeasonPlayerStats({ stats }: { stats: PlayerSeasonStat }) {
  ...
  const categorizedStats = Object.entries(ALL_SEASON_STAT_CATEGORIES)
