    ...
    <form onSubmit={handleSubmit} className="w-full max-w-4xl mx-auto px-4">
      <div className="relative">
        <input
          ...
          className="w-full rounded-full bg-[#fffbc5] placeholder-[#ffd000] border-2 border-[#ffd000] text-[#808080] text-2xl font-semibold py-4 px-6 focus:outline-none focus:ring-4 focus:ring-yellow-400 hover:ring-4 hover:ring-yellow-300 transition"
        />
        <button
          type="submit"
