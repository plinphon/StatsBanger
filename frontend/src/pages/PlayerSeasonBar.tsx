...
import { PlayerScatter2, PlayerBar } from "../components/allCharts2"
...
const METRIC_Y = "goals_assists_sum";
const POSITION = "M";
const BAR_LIMIT = 10;


export default function PlayerSeasonBar() {
        ...
        async function loadData() {
            try {
                ...
                const [stats] = await Promise.all([
                    fetchPlayerSeasonStatsWithMeta(UNIQUE_TOURNAMENT_ID, SEASON_ID, undefined, METRIC_Y)
                ])
                const formatedPlayerStats = stats.map(playerStat => ({
                    ...
                    [METRIC_Y]: playerStat.stats?.[METRIC_Y] ?? 0
                }));
