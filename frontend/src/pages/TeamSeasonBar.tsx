...
import { TeamScatter2, TeamBar } from "../components/allCharts2"
...
export default function TeamSeasonBar() {
    ...
    async function loadData() {
      try {
        ...
        const [stats] = await Promise.all([
                fetchTeamSeasonStatsWithMeta(UNIQUE_TOURNAMENT_ID, SEASON_ID, undefined, METRIC_Y)
        ])
