...
var ValidTopTeamFields = map[string]bool{
    "id": true, "team_id": true, "unique_tournament_id": true, "season_id": true,

    "goals_scored": true, "goals_conceded": true, "own_goals": true, "assists": true, "shots": true,
    "penalty_goals": true, "penalties_taken": true, "free_kick_goals": true, "free_kick_shots": true,
    "goals_from_inside_the_box": true, "goals_from_outside_the_box": true,
    "shots_from_inside_the_box": true, "shots_from_outside_the_box": true,
    "headed_goals": true, "left_foot_goals": true, "right_foot_goals": true,

    "big_chances": true, "big_chances_created": true, "big_chances_missed": true,
    "shots_on_target": true, "shots_off_target": true, "blocked_scoring_attempt": true,
    "successful_dribbles": true, "dribble_attempts": true, "corners": true,
    "hit_woodwork": true, "fast_breaks": true, "fast_break_goals": true, "fast_break_shots": true,

    "average_ball_possession": true,
    "total_passes": true, "accurate_passes": true, "accurate_passes_percentage": true,
    "total_own_half_passes": true, "accurate_own_half_passes": true,
    "accurate_own_half_passes_percentage": true,
    "total_opposition_half_passes": true, "accurate_opposition_half_passes": true,
    "accurate_opposition_half_passes_percentage": true,

    "total_long_balls": true, "accurate_long_balls": true, "accurate_long_balls_percentage": true,
    "total_crosses": true, "accurate_crosses": true, "accurate_crosses_percentage": true,

    "clean_sheets": true, "tackles": true, "interceptions": true, "saves": true,
    "errors_leading_to_goal": true, "errors_leading_to_shot": true,
    "penalties_committed": true, "penalty_goals_conceded": true,
    "clearances": true, "clearances_off_line": true, "last_man_tackles": true,

    "total_duels": true, "duels_won": true, "duels_won_percentage": true,
    "total_ground_duels": true, "ground_duels_won": true, "ground_duels_won_percentage": true,
    "total_aerial_duels": true, "aerial_duels_won": true, "aerial_duels_won_percentage": true,

    "possession_lost": true, "offsides": true, "fouls": true,
    "yellow_cards": true, "yellow_red_cards": true, "red_cards": true,

    "avg_rating": true,
    "accurate_final_third_passes_against": true, "accurate_opposition_half_passes_against": true,
    "accurate_own_half_passes_against": true, "accurate_passes_against": true,
    "big_chances_against": true, "big_chances_created_against": true,
    "big_chances_missed_against": true, "clearances_against": true,
    "corners_against": true, "crosses_successful_against": true, "crosses_total_against": true,
    "dribble_attempts_total_against": true, "dribble_attempts_won_against": true,
    "errors_leading_to_goal_against": true, "errors_leading_to_shot_against": true,
    "hit_woodwork_against": true, "interceptions_against": true,
    "key_passes_against": true, "long_balls_successful_against": true,
}
